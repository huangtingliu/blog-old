		...
		<%--          <img alt="Home" src="${resRoot}/img/null_img.png" height="35px" width="105px"> --%> 
		    ...
		    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			    <ul class="nav navbar-nav">
			    	<li class=""><a href="${ctxPath}/base/page/markdown/md?currentPage=blogList" class=""><span class="nav-title">博文列表</span></a></li>
			    	<li class=""><a href="${ctxPath}/base/page/markdown/md?currentPage=issueBlog" class=""><span class="nav-title">发布博文</span></a></li>
